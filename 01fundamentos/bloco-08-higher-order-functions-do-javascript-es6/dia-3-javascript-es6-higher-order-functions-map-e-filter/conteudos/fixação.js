...
// Função para buscar um estudante pelo nome e retornar a situação dele em cada matéria:
const reportStatus = (name, object) => {
  const studentInfo = object.find((student) => student.nome === name);
