...
function checkIfThisAnglesMakeATriangle(angleA, angleB, angleC) {
  if (angleA + angleB + angleC === 180) {
    return "Sim. Esses ângulos formam um triângulo.";
  } else if (angleA <= 0 || angleB <= 0 || angleC <= 0) {
    return "Algum dos ângulos informados é inválido!";
  } else {
    return "Não. Esses ângulos não formam um triângulo.";
  }
}

console.log(checkIfThisAnglesMakeATriangle(40, 50, 60));
console.log(checkIfThisAnglesMakeATriangle(-70, 50, 60));
console.log(checkIfThisAnglesMakeATriangle(70, 50, 60));
